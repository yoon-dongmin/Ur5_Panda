...
obj_state.append(['sweet_pepper', 'sweet_pepper', ['exist']])
obj_state.append(['feta_cheese', 'feta_cheese', ['exist']])
obj_state.append(['oregano', 'oregano', ['exist']])
obj_state.append(['black_olive', 'black_olive', ['exist']])
obj_state.append(['tomato', 'tomato', ['exist']])
obj_state.append(['potato', 'potato', ['exist']])
...
obj_place.append(['sweet_pepper', 'sweet_pepper', 'table1_ingredient_area', 'activated'])
obj_place.append(['feta_cheese', 'feta_cheese', 'table1_ingredient_area', 'activated'])
...
obj_place.append(['chopped_sweet_pepper', 'chopped_sweet_pepper', 'deactivate', 'deactivated'])
obj_place.append(['chopped_feta_cheese', 'chopped_feta_cheese', 'deactivate', 'deactivated'])
