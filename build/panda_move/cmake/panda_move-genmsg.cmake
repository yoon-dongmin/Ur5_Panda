...
set(MSG_I_FLAGS "-Ipanda_move:/carrot_ws/src/panda_move/msg;-Igeometry_msgs:/carrot_ws/src/geometry_msgs/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Imoveit_msgs:/carrot_ws/devel/share/moveit_msgs/msg;-Imoveit_msgs:/carrot_ws/src/moveit_msgs/msg;-Isensor_msgs:/opt/ros/melodic/share/sensor_msgs/cmake/../msg;-Iactionlib_msgs:/opt/ros/melodic/share/actionlib_msgs/cmake/../msg;-Itrajectory_msgs:/opt/ros/melodic/share/trajectory_msgs/cmake/../msg;-Ishape_msgs:/opt/ros/melodic/share/shape_msgs/cmake/../msg;-Iobject_recognition_msgs:/opt/ros/melodic/share/object_recognition_msgs/cmake/../msg;-Ioctomap_msgs:/opt/ros/melodic/share/octomap_msgs/cmake/../msg")
...
get_filename_component(_filename "/carrot_ws/src/panda_move/srv/Hand.srv" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/srv/Hand.srv" ""
)

get_filename_component(_filename "/carrot_ws/src/panda_move/srv/Plan.srv" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/srv/Plan.srv" "trajectory_msgs/JointTrajectory:geometry_msgs/Twist:trajectory_msgs/MultiDOFJointTrajectoryPoint:geometry_msgs/Transform:moveit_msgs/RobotTrajectory:trajectory_msgs/JointTrajectoryPoint:geometry_msgs/Quaternion:geometry_msgs/Vector3:std_msgs/Header:trajectory_msgs/MultiDOFJointTrajectory"
)

get_filename_component(_filename "/carrot_ws/src/panda_move/msg/Predicate.msg" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/msg/Predicate.msg" ""
)

get_filename_component(_filename "/carrot_ws/src/panda_move/srv/MotionCheck.srv" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/srv/MotionCheck.srv" ""
)

get_filename_component(_filename "/carrot_ws/src/panda_move/srv/Sync.srv" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/srv/Sync.srv" "geometry_msgs/Quaternion:geometry_msgs/Point"
)

get_filename_component(_filename "/carrot_ws/src/panda_move/srv/Init.srv" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/srv/Init.srv" "geometry_msgs/Vector3:geometry_msgs/Quaternion:geometry_msgs/Point"
)

get_filename_component(_filename "/carrot_ws/src/panda_move/srv/NewState.srv" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/srv/NewState.srv" "panda_move/Predicate"
)

get_filename_component(_filename "/carrot_ws/src/panda_move/msg/Action.msg" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/msg/Action.msg" ""
)

get_filename_component(_filename "/carrot_ws/src/panda_move/msg/ExecutionCheck.msg" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/msg/ExecutionCheck.msg" ""
)

get_filename_component(_filename "/carrot_ws/src/panda_move/srv/ActionSequences.srv" NAME_WE)
add_custom_target(_panda_move_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "panda_move" "/carrot_ws/src/panda_move/srv/ActionSequences.srv" "panda_move/Action"
)
...
_generate_srv_cpp(panda_move
  ...
  "${MSG_I_FLAGS}"
  "/carrot_ws/src/geometry_msgs/msg/Vector3.msg;/carrot_ws/src/geometry_msgs/msg/Quaternion.msg;/carrot_ws/src/geometry_msgs/msg/Point.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/panda_move
)
_generate_srv_cpp(panda_move
