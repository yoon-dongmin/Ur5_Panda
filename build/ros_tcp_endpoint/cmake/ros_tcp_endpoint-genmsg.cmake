...
set(MSG_I_FLAGS "-Iros_tcp_endpoint:/carrot_ws/src/ros_tcp_endpoint/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/carrot_ws/src/ros_tcp_endpoint/srv/RosUnityTopicList.srv" NAME_WE)
add_custom_target(_ros_tcp_endpoint_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_tcp_endpoint" "/carrot_ws/src/ros_tcp_endpoint/srv/RosUnityTopicList.srv" ""
)

get_filename_component(_filename "/carrot_ws/src/ros_tcp_endpoint/msg/RosUnityError.msg" NAME_WE)
add_custom_target(_ros_tcp_endpoint_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_tcp_endpoint" "/carrot_ws/src/ros_tcp_endpoint/msg/RosUnityError.msg" ""
)

get_filename_component(_filename "/carrot_ws/src/ros_tcp_endpoint/msg/RosUnitySrvMessage.msg" NAME_WE)
add_custom_target(_ros_tcp_endpoint_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_tcp_endpoint" "/carrot_ws/src/ros_tcp_endpoint/msg/RosUnitySrvMessage.msg" ""
)

get_filename_component(_filename "/carrot_ws/src/ros_tcp_endpoint/msg/RosUnitySysCommand.msg" NAME_WE)
add_custom_target(_ros_tcp_endpoint_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_tcp_endpoint" "/carrot_ws/src/ros_tcp_endpoint/msg/RosUnitySysCommand.msg" ""
)
...
_generate_srv_cpp(ros_tcp_endpoint
  "/carrot_ws/src/ros_tcp_endpoint/srv/RosUnityTopicList.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ros_tcp_endpoint
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tcp_endpoint)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tcp_endpoint\")")
  # install generated code
  install(
